...
export default function Login() {
  ...
  return (
    <div className="h-full flex justify-content-center align-items-center">
      ...
      >
        <rect fill="var(--primary-900)" width="1600" height="800"></rect>
        <path
      ...
      <Card className="login-card p-7 w-full relative z-5">
        <div>
        ...
        <Button label="Логин" onClick={handleLogin} loading={loading}></Button>
        <p className="error-text text-center m-0" style={{ color: "#ff6666" }}>
          {errorText}
        </p>
      </Card>
    </div>
